...
var hi = Object.assign, Ht = Object.getOwnPropertyDescriptor, _ = Object.defineProperty, or = Object.prototype, Wt = [];
Object.freeze(Wt);
var Xr = {};
Object.freeze(Xr);
...
function Ct(e, t, r) {
  if (H(e, ie) || lr(e, ie, ve({}, e[ie])), process.env.NODE_ENV !== "production" && Xt(r) && !H(e[ie], t)) {
...
var Ko = {
  ...
  deep: Pi,
  struct: /* @__PURE__ */ $(Ro)
}, C = /* @__PURE__ */ hi(Di, Ko), Ni = "computed", Fo = "computed.struct", zr = /* @__PURE__ */ Yr(Ni), Zo = /* @__PURE__ */ Yr(Fo, {
...
var fn, vn, Jt = 0, Ho = 1, Wo = (fn = (vn = /* @__PURE__ */ Ht(function() {
...
function Jo(e) {
  Jt !== e.actionId_ && f(30), Jt = e.parentActionId_, e.error_ !== void 0 && (p.suppressReactionErrors = !0), vr(e.prevAllowStateChanges_), ft(e.prevAllowStateReads_), q(), e.runAsAction_ && oe(e.prevDerivation_), process.env.NODE_ENV !== "production" && e.notifySpy_ && U({
...
var Yo = "create", Se = /* @__PURE__ */ function(e) {
  ...
  return t.onBecomeStale_ = function() {
    ...
    return vr(i), this.isComputing = !1, a;
  }, t.suspend_ = function() {
...
K.diffValueMask_ = 16;
var hr = /* @__PURE__ */ Ue("ComputedValue", K), w;
(function(e) {
...
function U(e) {
  process.env.NODE_ENV !== "production" && Ve(e ? ve({}, e, {
    type: "report-end",
    spyReportEnd: !0
  }) : os);
}
...
function $r(e, t, r) {
  ...
  var o = (n = r.name) != null ? n : process.env.NODE_ENV !== "production" ? "Reaction@" + F() : "Reaction", s = Ce(o, r.onError ? fs(r.onError, t) : t), l = !r.scheduler && !r.delay, c = Wi(r), d = !0, u = !1, v, h = r.compareStructural ? Xe.structural : r.equals || Xe.default, m = new ee(o, function() {
    d || l ? O() : u || (u = !0, c(O));
...
function xs(e, t) {
  return e ? tt(e) || !!e[g] || Gr(e) || Yt(e) || hr(e) : !1;
}
function wt(e) {
  ...
  return t.getObservablePropValue_ = function(n) {
    ...
    try {
      ...
      if (process.env.NODE_ENV !== "production" && delete this.appliedAnnotations_[n], c && (this.values_.delete(n), c instanceof Se && (d = c.value_), ji(c)), this.keysAtom_.reportChanged(), (o = this.pendingKeys_) == null || (o = o.get(n)) == null || o.set(n in this.target_), s || l) {
        ...
        process.env.NODE_ENV !== "production" && l && z(v), s && X(this, v), process.env.NODE_ENV !== "production" && l && U();
      }
    } finally {
      q();
    }
...
function ia(e, t) {
  if (e || f(29), Gr(e) || hr(e) || Yt(e) || be(e) || Y(e))
    return e;
  if (e[g])
    return e[g];
  f(24, e);
...
const Nt = async (e, t, r) => window.Vaadin.copilot.comm(e, t, r), he = "copilot-", ll = "25.0.0-rc1", cl = "undefined", Td = "attention-required", Id = "https://plugins.jetbrains.com/plugin/23758-vaadin", zd = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode", Ud = "https://marketplace.eclipse.org/content/vaadin-tools";
function Ld(e) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: ql, defineProperty: Bl, getOwnPropertyDescriptor: Kl, getOwnPropertyNames: Fl, getOwnPropertySymbols: Zl, getPrototypeOf: Hl } = Object, mr = globalThis, Fn = mr.trustedTypes, Wl = Fn ? Fn.emptyScript : "", Xl = mr.reactiveElementPolyfillSupport, vt = (e, t) => e, Fr = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? Wl : null;
      break;
...
Ke.elementStyles = [], Ke.shadowRootOptions = { mode: "open" }, Ke[vt("elementProperties")] = /* @__PURE__ */ new Map(), Ke[vt("finalized")] = /* @__PURE__ */ new Map(), Xl?.({ ReactiveElement: Ke }), (mr.reactiveElementVersions ??= []).push("2.1.0");
    ...
    for (; (i = Ae.nextNode()) !== null && l.length < s; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const u of i.getAttributeNames()) if (u.endsWith(xa)) {
          ...
          l.push({ type: 1, index: a, name: m[2], strings: h, ctor: m[1] === "." ? ec : m[1] === "?" ? tc : m[1] === "@" ? rc : br }), i.removeAttribute(u);
...
function dc() {
  ke.push(import("./copilot-log-plugin-D1P4XUyj.js")), ke.push(import("./copilot-info-plugin-BHjgjhRh.js")), ke.push(import("./copilot-features-plugin-Bicr2qJb.js")), ke.push(import("./copilot-feedback-plugin-Ci8JMTfk.js")), ke.push(import("./copilot-shortcuts-plugin-DTEbOjj9.js"));
}
function uc() {
  {
...
let vi = class extends cc {
  ...
  detectAppTheme() {
    Vn("lumo") ? b.setAppTheme("lumo") : Vn("aura") ? b.setAppTheme("aura") : b.setAppTheme(null), Nt(`${he}set-app-theme`, { theme: b.appTheme }, () => {
    });
  }
};
vi = Ed([
