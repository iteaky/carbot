import { r as b, M as $, u as ge, v as N, b as h, j as l, C as K, w as p, x as m, y as se, z as Y, A as O, O as xe, B as R, D as r, F as X, G as pt, H as ht, I as ut, J as f, K as Q, L as Se, N as Ee, E as g, Q as Ve, k as ae, l as Je, P as qe, R as gt, V as ft, S as c, T as We, U as E, W as vt, X as z, Y as k, Z as Pe, _ as Ie, $ as Ge, a0 as mt, a1 as le, a2 as bt, a3 as Re, a4 as wt, a5 as yt, a6 as xt, a7 as Pt, a8 as Ye, a9 as It, aa as At, ab as $t, ac as Xe, ad as Ct, ae as kt, af as St, ag as Et, ah as Ke, ai as Rt, aj as Ae, ak as $e, al as Dt } from "./copilot-FMkXCpRK.js";
import { n as y, r as x } from "./state-DH6Kmx5o.js";
import { e as T } from "./query-BykXNUlT.js";
import { i as d } from "./icons-3ggBm36p.js";
import { c as Ze } from "./index-DJOAAqfC.js";
const Lt = 1, De = 40, zt = 18;
function Mt(e, t) {
  if (e.length === 0)
    return;
  const i = _t(e, t);
...
function _t(e, t) {
  ...
  return e.map((s) => {
    const a = s.panelInfo;
    return a && !a.expanded ? De : (t.offsetHeight - (t.position === "bottom" ? zt : 0) - o * De - i * Lt) / n;
  });
}
...
class jt {
  ...
  adjust(t, i, n, o, s) {
    ...
    return (o + i) / 2 < L / 2 ? (t.style.setProperty("--left", `${i}px`), t.style.setProperty("--right", ""), S = void 0, a = Math.max(0, i)) : (t.style.removeProperty("--left"), t.style.setProperty("--right", `${L - o}px`), a = void 0, S = Math.max(0, L - o)), (n + s) / 2 < re / 2 ? (u = Math.max(0, n), t.style.setProperty("--top", `${u}px`), t.style.setProperty("--bottom", ""), w = void 0) : (t.style.setProperty("--top", ""), t.style.setProperty("--bottom", `${re - s}px`), u = void 0, w = Math.max(0, re - s)), {
      left: a,
      right: S,
      top: u,
      bottom: w
...
let I = class extends $ {
  ...
  renderHotswapAgentJdkSection(e) {
    const t = f.jdkInfo?.extendedClassDefCapable, i = this.downloadStatusMessages?.[this.downloadStatusMessages.length - 1] === ze;
    return r`
      <div class="inner-section">
        <details class="inner" .open="${!t}">
          <summary>
  ...
  async downloadJetbrainsRuntime(e) {
    return e.target.disabled = !0, e.preventDefault(), this.downloadStatusMessages = [], ae(`${qe}set-up-vs-code-hotswap`, {}, (t) => {
      t.data.error ? (Je("Error downloading JetBrains runtime", t.data.error), this.downloadStatusMessages = [...this.downloadStatusMessages, "Download failed"]) : this.downloadStatusMessages = [...this.downloadStatusMessages, ze];
    });
  }
...
let _e = class extends $ {
  ...
  render() {
    const t = We(), { status: i, message: n } = t;
    let o = "", s = "", a = "";
...
let Te = class extends $ {
  ...
  clickListener() {
    ...
    if (E.active) {
      ...
      }).catch((e) => Je("Login processing failed", e));
      return;
    }
...
let _ = class extends $ {
  constructor() {
    super(...arguments), this.panelTag = "", this.dockingItems = [
      ...
      let u = "";
      i < a ? o < a ? (u = "nw-resize", this.setAttribute(P, "top left")) : s < a ? (u = "sw-resize", this.setAttribute(P, "bottom left")) : (u = "col-resize", this.setAttribute(P, "left")) : n < a ? o < a ? (u = "ne-resize", this.setAttribute(P, "top right")) : s < a ? (u = "se-resize", this.setAttribute(P, "bottom right")) : (u = "col-resize", this.setAttribute(P, "right")) : s < a ? (u = "row-resize", this.setAttribute(P, "bottom")) : o < a && (u = "row-resize", this.setAttribute(P, "top")), u !== "" ? (this.rectangleBeforeResizing = this.getBoundingClientRect(), this.style.setProperty("--resize-cursor", u)) : (this.style.removeProperty("--resize-cursor"), this.removeAttribute(P)), this.toggleAttribute(he, u !== "");
...
const mi = {
   ...
   */
  run(e) {
    be || (be = !0, queueMicrotask(() => vi())), j.push(e);
    const t = je;
    return je += 1, t;
  },
  /**
...
const st = Ae(Ii), at = Ae(Ai), rt = Ae($i);
